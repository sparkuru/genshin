# x86_64-linux-6.18.7-glibc

Generic Buildroot/QEMU environment for x86-64 Linux binaries. It uses glibc,
...
guest telnetd only on `127.0.0.1:4548`:

```sh
./run-qemu.sh --background --share /path/to/programs
telnet 127.0.0.1 4548
./stop-qemu.sh
```
