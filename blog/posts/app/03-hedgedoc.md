---
title: "app | hedgedoc"
description: "hedgedoc, the open src version of hackmd, a coopperation markdown platform."
date: "2022-03-18T06:24:00.000Z"
updated: "2024-04-03T11:28:52.000Z"
tags: []
draft: false
layout: "post"
slug: "hedgedoc"
...
3.   使用 docker-compose 来部署 hedgedoc；贴一个自己用的配置文件，这里是根据上文自己创建的 MySQL 数据库来配置的，这样做的好处是今后 hedgedoc 源镜像在哪都能 pull 一份官方的，而数据库和图片信息都在本地，更好移植；配置更多内容，参考高级配置文件：[configuration](https://docs.hedgedoc.org/configuration/)
     ...
     services:
       hedgedoc:
         ...
         volumes:
           - /srv/www/hedgedoc/uploads:/hedgedoc/public/uploads
           - /srv/www/hedgedoc/config:/config
         ports:
           - 2000:3000
         restart: always
     
     # sudo docker-compose -f /srv/www/hedgedoc/hedgedoc.yml up -d
     ```
