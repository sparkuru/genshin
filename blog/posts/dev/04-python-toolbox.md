---
title: "python-maho"
description: "python's magic."
date: "2024-12-24T07:24:00.000Z"
updated: "2025-01-06T05:45:47.000Z"
tags: []
draft: false
layout: "post"
slug: "python-toolbox"
...
```bash
PS %USERPROFILE%\wkyuu\Desktop\mods> rename -h
...
```powershell
   PS %USERPROFILE%\wkyuu\Desktop\mods> rename -w 3 -m add prefix
...
```
   ...
   2.   `-m`，mode，表示模式；如果改成 `-m remove`，就是自动识别上面的数字前缀并删除
        ...
        ```powershell
        PS %USERPROFILE%\wkyuu\Desktop\mods> rename -w 3 -m remove prefix
...
```powershell
PS %USERPROFILE%\wkyuu\Desktop\mods> fd
...
```powershell
PS %USERPROFILE%\wkyuu\Desktop\mods> rename -o '] ' -n ']' replace
...
```powershell
PS %USERPROFILE%\wkyuu\Desktop\mods> rename -w 2 -m add prefix
...
```powershell
PS %USERPROFILE%\wkyuu\Desktop\mods> rename -w 2 -m remove prefix
