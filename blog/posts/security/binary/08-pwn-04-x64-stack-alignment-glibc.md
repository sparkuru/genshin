---
title: "ctf | 04_pwn-字节对齐与glibc"
description: "rop 中 x64 调用 system 时出现 16 字节对齐的情况，以及关于 glibc、patchelf、glibc all in one 等补充知识。"
date: "2023-02-26T12:31:00.000Z"
updated: "2024-04-27T02:39:27.000Z"
tags: ["CTF","pwn"]
draft: false
layout: "post"
slug: "pwn-04-x64-stack-alignment-glibc"
---
...
![image-20230204095624790](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20230204095624790.png)

没有 **canary**，程序地址不变

### elf

![image-20230204095745967](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20230204095745967.png)

输入即返回

![image-20230204100102940](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20230204100102940.png)

执行情况

![image-20230225105426928](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20230225105426928.png)

没有长度检查，手动输入来截断，十分简单的 **stackoverflow**，

![image-20230204101644336](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20230204101644336.png)
...
![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20230225164623503.png)

下图是 Kali 使用的 GLIBC 版本：

![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20230225164752668.png)
...
![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20230226194342467.png)
...
![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20230226195715774.png)
...
![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20230226201828770.png)
...
![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20221128211536110.png)

`libc.so.6`，也就是 **glibc** 的软链接表示，是 **Linux** 系统中最底层的 **api**，几乎任何运行库都将依赖于 **glibc**，在这里可以片面的理解为

![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20221128212139954.png)

这里的 **libc6_2.23-0ubuntu2_amd64.so** 就是从 [pwn 题常用 libc 库查询](https://libc.rip) 拿下来的，有的时候有些题目也会给你供应一个 **libc.so.6**

![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20221128212320223.png)

查看自己系统中的 **libc.so.6** 可以发现，确实有两个不同的 **libc.so.6**，分别应用于 **32位** 和 **64位** 应用

![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20221128213120365.png)
...
![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20221128212948006.png)
...
![image-20221129110056984](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20221129110056984.png)
...
2. 打题目必用组件，**patchelf**（使用 `sudo apt install patchelf` 来安装）：
  ...
  ![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20221129111938568.png)
...
2. 相关配置：
	...
	2. 获取列表：`./update_list && cat list`
		...
		![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20221129112846931.png)
