---
title: "ctf | 02_pwn-fmt-strings"
description: "格式化字符串单字节写。"
date: "2022-11-25T09:58:00.000Z"
updated: "2024-04-27T02:39:15.000Z"
tags: ["CTF","pwn"]
draft: false
layout: "post"
slug: "pwn-02-format-string-write"
---
...
![image-20221125145422452](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20221125145422452.png)

没有 PIE，有 canary，栈上不可执行

### elf

![image-20221125145548907](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20221125145548907.png)

使用 **ida64** 查看

![image-20221125145826239](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20221125145826239.png)
...
![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20221125170120894.png)

图中可以明确的是 **exit@got** 位置可写，其地址上的内容为 **0x401090**，那么可以 `0x404048 的 \x90 -> \xa5`，`0x404049 的 \x10 -> \x12`

通过 **gdb.attach(p, gdbscript="b *main+122")** 在输入时确定 fmt 的偏移位置：`fmtarg <目标地址>`，如图所示，则调用 `fmtChangeByte('90', 12)` 即可

![](https://tataramoriko-oss.oss-cn-shenzhen.aliyuncs.com/markdown/image-20221125170917348.png)
