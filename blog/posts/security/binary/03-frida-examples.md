---
title: "frida-使用范例"
description: "一款 Android、Linux、Windows 等平台上的动态插桩工具"
date: "2024-01-25T14:05:00.000Z"
updated: "2024-08-19T07:01:16.000Z"
tags: []
draft: false
layout: "post"
slug: "frida-examples"
...
-   在 Linux 上安装完成后将其添加到环境变量：`export PATH=$PATH:~/.local/bin`，可以写到 `~/.bashrc` 中，执行 `frida --version` 查看版本号
