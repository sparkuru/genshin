...
date: "2024-04-18T09:02:00.000Z"
updated: "2024-12-24T02:54:34.000Z"
tags: []
draft: false
layout: "post"
slug: "vim-notes"
...
## header1
 ...
 para2 
    ...
    将光标放置于 header1 的 h，输入 `dit` 则删除整个 *header1*，输入 `dat` 删除 *\

## header1\

*
    将光标放置于 div 处，`dit` 将删除 *\

\

* 内所有的 h1 和 p，`dat` 将额外删除 div 整个模块，如果是 `di<` 则删除 *div* 这三个字符（和上文的 `di(` 逻辑类似）
